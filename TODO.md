- [ ] Add local file manipulation tools for framework langgraph, including read_lines(filename, start, end), grep(filename, regex), create(filename, content), delete(filename)
